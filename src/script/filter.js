...
function showingList(index, service, city) {
  if (service == "restaurant") {
    ...
    <img class="images produit"src="${city.restaurant.businesses[index].image_url}" alt="Placeholder Image" class="w-full h-full object-contain  cursor-pointer">
    </div>
    <div class="px-6 py-4">
      <div class="produit font-bold text-xl mb-2 cursor-pointer">${city.restaurant.businesses[index].name}</div>
    ...
    <div class="image-container w-full h-fit" style="height: 200px; width: 100%; overflow: hidden;">
    <img src="${city.event.businesses[index].image_url}" alt="Placeholder Image" class="w-full h-full object-contain service-image">
    </div>
    <div class="px-6 py-4">
      <div class="font-bold text-xl mb-2 cursor-pointer">${city.event.businesses[index].name}</div>
